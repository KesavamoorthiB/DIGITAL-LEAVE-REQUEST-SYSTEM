...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if (file_put_contents($pdfFilePath, file_get_contents($pdf))) {
            ...
            $updateSql = "UPDATE ks SET coordinator_approval = 'Pending Coordinator Approval' WHERE registerNo = '$registerNo'";
            ...
            $hodBody = "Hello HOD,<br><br> Please review the leave request for $name and take appropriate action:<br><br>";
            $hodBody .= '<a href="http://yourwebsite.com/approve.php?registerNo='.$registerNo.'">Approve</a> | ';
            $hodBody .= '<a href="http://yourwebsite.com/reject.php?registerNo='.$registerNo.'">Reject</a><br><br>';
            $hodBody .= '...';  // Customize the rest of the email body
            ...
            $userMessage = 'Thankyou, Your leave request has been submitted sucessfylly.';
